...
docker run -d --name neo4j -p 7474:7474 -p 7687:7687 --env NEO4J_AUTH=neo4j/$NEO4J_PASSWORD_SECRET -v /home/ubuntu/AmpliconRepository-${AMPLICON_ENV}/neo4j/conf:/var/lib/neo4j/conf -v /home/ubuntu/AmpliconRepository-${AMPLICON_ENV}/neo4j/data:/var/lib/neo4j/data   neo4j:2025.03.0