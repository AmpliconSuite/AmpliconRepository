...
import RealOncoPrint from './OncoprintFrag.react'

console.log('RealOncoPrint', RealOncoPrint)
...
export const custom_defaultProps = OncoPrint.defaultProps;
export const custom_propTypes = OncoPrint.propTypes;
