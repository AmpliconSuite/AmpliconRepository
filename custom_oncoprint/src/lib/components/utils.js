...
const MutationEventTypes = ['INFRAME', 'TRUNC', 'MISSENSE', 'ECDNA', 'BFB', 'CNC', 'LIN'];
...
export const SupportedEvents = {
    ...
    BFB: {
        colorHTML:' #993404',
        displayName: 'Breakage fusion bridge'
    },
    CNC: {
        colorHTML:' #008000',
        displayName: 'Complex non-cyclic'
    },
    LIN: {
        colorHTML:' #ff0000',
        displayName: 'Linear amplificatoin'
    },
