...
ALLOWED_HOSTS = ["localhost",'www.ampliconrepository.org', 'ampliconrepository.org','dev.ampliconrepository.org','172.31.29.144','50.19.227.137', 'host.docker.internal', '172.31.85.178']
...
EMAIL_PORT = 587 #new
EMAIL_HOST_USER_SECRET = os.getenv('EMAIL_HOST_USER_SECRET', default="")  #new
EMAIL_HOST_PASSWORD_SECRET = os.getenv('EMAIL_HOST_PASSWORD_SECRET', default="")
